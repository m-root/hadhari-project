    ...
    function mainMap() {
        ...
        function locationData(locationURL, locationImg, locationTitle, locationAddress) {
            return (
                ...
                '<div class="listing-item-content">' + '<h3>' + locationTitle + '</h3>' + '<span>' + locationAddress + '</span>' + '</div>' +
                '</a>' +
            ...
            success: function (response) {
                ...
                for (let p in response) {
                        ...
                        locations.push(
                            [
                                locationData(
                                '/daycares/'+response[p]['id']+'/',
                                'static/images/listing-item-01.jpg',
                                response[p]['name'],
                                '964 School Street, New York', '3.5', '12'
                                ),
                                response[p]['lat'],
                                response[p]['lng'],
                                1,
                                '<i class="im im-icon-Baby"></i>'
                            ]
                        );
                ...
                var map = new google.maps.Map(document.getElementById('map'), {
                    ...
                    center: new google.maps.LatLng(-1.2959022,36.8604751),
